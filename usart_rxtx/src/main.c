...
USART1 TX -->GPIOA Pin9, RX (interrupt)-->GPIOA Pin10
* Minicom :"Hello Word" scrolling  
* Minicom :If ASCII char Rx < 5, Turn On LED
...
void USART1_Init(void){
	...
	// OVER8=1, TX & RX Enable, Rx interrrupt enable
	USART1->CR1|= USART_CR1_OVER8|USART_CR1_TE|USART_CR1_RE|USART_CR1_RXNEIE;
